 ...
 *
 * Set Trigger direction: 23x
 *   Sets whether the system is triggered from the trigger pin going high to low,
 *   or low to high. Default is low to high. x=0 is low to high. x=1 is high to low.
 *   controller returns 23x
 *   
