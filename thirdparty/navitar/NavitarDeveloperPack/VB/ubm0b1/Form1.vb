...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New()
        ...
        Do
            ...
            usbFirst1 = USBFindUSBinterfaces()

            ' connect to the 1st brightlight found 
            usbHandle3 = USBConnectionConnect(1, DEF_BRIGHTLIGHT)         ' connect to port 1 brightlight

            If usbHandle3 = &H100 Then
                Dim response As MsgBoxResult
                response = MsgBox("USB brightlight 1 did not open or connect", MsgBoxStyle.AbortRetryIgnore)
                If response = MsgBoxResult.Retry Then   ' User chose Yes.
                    usbFirst3 = USBFindUSBinterfaces()
                    usbHandle3 = USBConnectionConnect(1, DEF_BRIGHTLIGHT)         ' connect to port 1, Motor controller
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'GroupBox1
        '
        Me.GroupBox1.Controls.Add(Me.Button_FullOn1)
        Me.GroupBox1.Controls.Add(Me.Button_Plus1)
        Me.GroupBox1.Controls.Add(Me.Button_Mid1)
        Me.GroupBox1.Controls.Add(Me.Button_Minus1)
        Me.GroupBox1.Controls.Add(Me.Button_Off1)
        Me.GroupBox1.Controls.Add(Me.Value1)
        Me.GroupBox1.Location = New System.Drawing.Point(16, 16)
        Me.GroupBox1.Name = "GroupBox1"
        Me.GroupBox1.Size = New System.Drawing.Size(152, 320)
        Me.GroupBox1.TabIndex = 2
        Me.GroupBox1.TabStop = False
        Me.GroupBox1.Text = "BrightLight 1"
        '
        'Button_FullOn1
        '
        ...
        Me.ClientSize = New System.Drawing.Size(200, 381)
