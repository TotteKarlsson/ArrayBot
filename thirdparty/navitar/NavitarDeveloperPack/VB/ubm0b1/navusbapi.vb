...
Module navusbapi
    ...
    Declare Auto Function USBFindUSBinterfaces Lib "navusbAPI.dll" () As Integer
    Declare Auto Function USBConnectionConnect Lib "navusbAPI.dll" (ByVal Port As Integer, ByVal ProductID As Integer) As Integer
    Declare Auto Function USBConnectionConnectSpec Lib "navusbAPI.dll" (ByVal Port As Integer, ByVal ProductID As Integer, ByVal ProductType As Integer) As Integer
    Declare Auto Function USBConnectionEstablished Lib "navusbAPI.dll" (ByVal serHandle As Integer, ByVal ProductID As Integer) As Integer
    Declare Auto Function USBConnectionRead Lib "navusbAPI.dll" (ByVal serHandle As Integer, ByVal reg As Byte, ByRef Value As Integer) As Integer
    Declare Auto Function USBConnectionWrite Lib "navusbAPI.dll" (ByVal serHandle As Integer, ByVal reg As Byte, ByRef Value As Integer) As Integer
    Declare Auto Function USBConnectionDisconnect Lib "navusbAPI.dll" (ByVal serHandle As Integer) As Integer
    Declare Auto Function USBConnectionDisconnectAll Lib "navusbAPI.dll" () As Integer
