// ucm1b0Dlg.cpp : implementation file
//
...
CUcm1b0Dlg::CUcm1b0Dlg(CWnd* pParent /*=NULL*/)
	: CDialog(CUcm1b0Dlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CUcm1b0Dlg)
...
void CUcm1b0Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CUcm1b0Dlg)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CUcm1b0Dlg, CDialog)
	//{{AFX_MSG_MAP(CUcm1b0Dlg)
	ON_WM_SYSCOMMAND()
	ON_WM_DESTROY()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
/////////////////////////////////////////////////////////////////////////////
// CUcm1b0Dlg message handlers

BOOL CUcm1b0Dlg::OnInitDialog()
{
...
void CUcm1b0Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CUcm1b0Dlg::OnQueryDragIcon()
{
	return (HCURSOR) m_hIcon;
}


void CUcm1b0Dlg::OnTimer(UINT nIDEvent) 
{
	USBConnectionRead(usbHandle1,REG_USER_CURRENT_1,&temp);
	sprintf(buff,"%d",temp);
	GetDlgItem(IDC_EDIT_1_LOC1)->SetWindowText(buff);
