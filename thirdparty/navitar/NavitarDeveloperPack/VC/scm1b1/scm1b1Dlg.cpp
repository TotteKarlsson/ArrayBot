// scm1b1Dlg.cpp : implementation file
//
...
CScm1b1Dlg::CScm1b1Dlg(CWnd* pParent /*=NULL*/)
	: CDialog(CScm1b1Dlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CScm1b1Dlg)
...
void CScm1b1Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CScm1b1Dlg)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CScm1b1Dlg, CDialog)
	//{{AFX_MSG_MAP(CScm1b1Dlg)
	ON_WM_SYSCOMMAND()
	ON_WM_DESTROY()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
/////////////////////////////////////////////////////////////////////////////
// CScm1b1Dlg message handlers

BOOL CScm1b1Dlg::OnInitDialog()
{
	...
	serHandle3 = SerConnectionConnect(COM2,DEF_BRIGHTLIGHT);
...
void CScm1b1Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CScm1b1Dlg::OnQueryDragIcon()
{
	return (HCURSOR) m_hIcon;
}

void CScm1b1Dlg::OnTimer(UINT nIDEvent) 
{
	SerConnectionRead(serHandle1,REG_USER_CURRENT_1,&temp);
	sprintf(buff,"%d",temp);
	GetDlgItem(IDC_EDIT_1_LOC1)->SetWindowText(buff);
...
void CScm1b1Dlg::OnButton1Home1() 
{
	temp = 0;
	SerConnectionWrite(serHandle1, REG_USER_LIMIT_1, &temp);
}

void CScm1b1Dlg::OnButton1Minus1() 
{
	temp = -100;
	SerConnectionWrite(serHandle1, REG_USER_INCREMENT_1, &temp);
}

void CScm1b1Dlg::OnButton11000g1() 
{
	temp = 1000;
	SerConnectionWrite(serHandle1, REG_USER_TARGET_1, &temp);
}

void CScm1b1Dlg::OnButton1Plus1() 
{
	temp = +100;
	SerConnectionWrite(serHandle1, REG_USER_INCREMENT_1, &temp);
}

void CScm1b1Dlg::OnButton1Limit1() 
{
	temp = 1;
	SerConnectionWrite(serHandle1, REG_USER_LIMIT_1, &temp);
}

void CScm1b1Dlg::OnButton2Home1() 
{
	temp = 0;
	SerConnectionWrite(serHandle1, REG_USER_LIMIT_2, &temp);
}

void CScm1b1Dlg::OnButton2Minus1() 
{
	temp = -100;
	SerConnectionWrite(serHandle1, REG_USER_INCREMENT_2, &temp);
}

void CScm1b1Dlg::OnButton21000g1() 
{
	temp = 1000;
	SerConnectionWrite(serHandle1, REG_USER_TARGET_2, &temp);
}

void CScm1b1Dlg::OnButton2Plus1() 
{
	temp = +100;
	SerConnectionWrite(serHandle1, REG_USER_INCREMENT_2, &temp);
}

void CScm1b1Dlg::OnButton2Limit1() 
{
	temp = 1;
	SerConnectionWrite(serHandle1, REG_USER_LIMIT_2, &temp);
}

void CScm1b1Dlg::OnButtonOff1() 
{
	temp = 0;
	SerConnectionWrite(serHandle3,REG_PWM_ABSOLUTE,&temp);
}

void CScm1b1Dlg::OnButtonMinus1() 
{
	temp = -100;
	SerConnectionWrite(serHandle3,REG_PWM_INCREMENT,&temp);
}

void CScm1b1Dlg::OnButtonMid1() 
{
	temp = 500;
	SerConnectionWrite(serHandle3,REG_PWM_ABSOLUTE,&temp);
}

void CScm1b1Dlg::OnButtonPlus1() 
{
	temp = +100;
	SerConnectionWrite(serHandle3,REG_PWM_INCREMENT,&temp);
}

void CScm1b1Dlg::OnButtonFullon1() 
{
	temp = 1000;
	SerConnectionWrite(serHandle3,REG_PWM_ABSOLUTE,&temp);
}
