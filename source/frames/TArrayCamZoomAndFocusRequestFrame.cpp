#include <vcl.h>
#pragma hdrstop
#include "TArrayCamZoomAndFocusRequestFrame.h"
...
#pragma resource "*.dfm"
TArrayCamZoomAndFocusRequestFrame *ArrayCamZoomAndFocusRequestFrame;

//---------------------------------------------------------------------------
__fastcall TArrayCamZoomAndFocusRequestFrame::TArrayCamZoomAndFocusRequestFrame(ProcessSequencer& ps, TComponent* Owner)
	: TFrame(Owner),
...
void TArrayCamZoomAndFocusRequestFrame::populate(AbsoluteMove* m)
{
    MotorsCB->Clear();
	populateMotorCB();
    rePopulate(m);
...
void TArrayCamZoomAndFocusRequestFrame::rePopulate(AbsoluteMove* m)
{
	if(!m)
    {
    	return;
...
void TArrayCamZoomAndFocusRequestFrame::populateMotorCB()
{
...
//---------------------------------------------------------------------------
void __fastcall TArrayCamZoomAndFocusRequestFrame::MotorsCBChange(TObject *Sender)
{
...
void __fastcall TArrayCamZoomAndFocusRequestFrame::mMovePosEKeyDown(TObject *Sender, WORD &Key, TShiftState Shift)
{
...
//---------------------------------------------------------------------------
void __fastcall TArrayCamZoomAndFocusRequestFrame::TriggersLBClick(TObject *Sender)
{
...
void __fastcall TArrayCamZoomAndFocusRequestFrame::mDeleteTriggerBClick(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TArrayCamZoomAndFocusRequestFrame::AddTriggerBClick(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TArrayCamZoomAndFocusRequestFrame::mActionInfoClick(TObject *Sender)
{
    if(!mMove)
    {
    	return;
