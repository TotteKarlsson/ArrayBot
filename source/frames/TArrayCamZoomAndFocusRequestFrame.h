#ifndef TArrayCamZoomAndFocusRequestFrameH
#define TArrayCamZoomAndFocusRequestFrameH
...
class PACKAGE TArrayCamZoomAndFocusRequestFrame : public TFrame
{
__published:	// IDE-managed Components
    ...
    public:		// User declarations
                        __fastcall TArrayCamZoomAndFocusRequestFrame(ProcessSequencer& ps, TComponent* Owner);
        void            		   populate(AbsoluteMove* m);
        void            		   rePopulate(AbsoluteMove* m);
};

extern PACKAGE TArrayCamZoomAndFocusRequestFrame *ArrayCamZoomAndFocusRequestFrame;
#endif
