...
CREATE TABLE `coverslipdustassays` (
  ...
  CONSTRAINT `coverslipdustassays_ibfk_1` FOREIGN KEY (`coverslip_id`) REFERENCES `coverslip` (`id`) ON DELETE CASCADE,
  CONSTRAINT `coverslipdustassays_ibfk_2` FOREIGN KEY (`coverslip_status`) REFERENCES `coverslipstatus` (`id`)
...
CREATE TABLE `cryoprotection` (
  ...
  CONSTRAINT `cryoprotection_ibfk_1` FOREIGN KEY (`document_id`) REFERENCES `documents` (`id`)
...
CREATE TABLE `embedding` (
  ...
  PRIMARY KEY (`id`),
  KEY `document_id` (`document_id`),
  CONSTRAINT `embedding_ibfk_1` FOREIGN KEY (`document_id`) REFERENCES `documents` (`id`)
...
CREATE TABLE `fixative` (
  ...
  PRIMARY KEY (`id`),
  KEY `document_id` (`document_id`),
  CONSTRAINT `fixative_ibfk_1` FOREIGN KEY (`document_id`) REFERENCES `documents` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
...
CREATE TABLE `fixmethod` (
  ...
  PRIMARY KEY (`id`),
  KEY `document_id` (`document_id`),
  CONSTRAINT `fixmethod_ibfk_1` FOREIGN KEY (`document_id`) REFERENCES `documents` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
...
CREATE TABLE `freezeprotocol` (
  ...
  PRIMARY KEY (`id`),
  KEY `document_id` (`document_id`),
  CONSTRAINT `freezeprotocol_ibfk_1` FOREIGN KEY (`document_id`) REFERENCES `documents` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;
...
CREATE TABLE `infiltration` (
  ...
  PRIMARY KEY (`id`),
  KEY `document_id` (`document_id`),
  CONSTRAINT `infiltration_ibfk_1` FOREIGN KEY (`document_id`) REFERENCES `documents` (`id`)
...
CREATE TABLE `postfix` (
  ...
  PRIMARY KEY (`id`),
  KEY `document_id` (`document_id`),
  CONSTRAINT `postfix_ibfk_1` FOREIGN KEY (`document_id`) REFERENCES `documents` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8;
...
CREATE TABLE `preprocesstreatment` (
  ...
  PRIMARY KEY (`id`),
  KEY `document_id` (`document_id`),
  CONSTRAINT `preprocesstreatment_ibfk_1` FOREIGN KEY (`document_id`) REFERENCES `documents` (`id`)
...
CREATE TABLE `substitution` (
  ...
  PRIMARY KEY (`id`),
  KEY `document_id` (`document_id`),
  CONSTRAINT `substitution_ibfk_1` FOREIGN KEY (`document_id`) REFERENCES `documents` (`id`)
