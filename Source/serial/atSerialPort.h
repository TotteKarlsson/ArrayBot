...
//TK Changes: renamed unit files to atSerialPort
...
namespace at
{
    ...
    public:
    	...
    	EPort;
            ...
            virtual LONG 								Setup (EBaudrate eBaudrate = EBaud9600,	EDataBits eDataBits = EData8,
                                							EParity eParity = EParNone,	EStopBits eStopBits = EStop1);
