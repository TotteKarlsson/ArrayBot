...
void __fastcall TAboutArrayBotFrame_2::retrieveChangeLogAExecute(TObject *Sender)
{
...
void __fastcall TAboutArrayBotFrame_2::NotifyAboutUpdate(const string& data)
{
    if(data.size())
    {
...
//Executed in a thread
void __fastcall TAboutArrayBotFrame_2::NotifyAboutChangeLog(const string& data)
{
    if(data.size())
    {
...
//---------------------------------------------------------------------------
void __fastcall TAboutArrayBotFrame_2::ThreadCheckTimerTimer(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TAboutArrayBotFrame_2::showChangeLogExecute(TObject *Sender)
{
    try
    {
